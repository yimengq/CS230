...
# Custom Classes
"Import all the functions from preprocess"
import preprocess

"Simply apply the functions to create two datasets train A and train B"
...
"Modify the information below to preprocess the data and save them into new directory paths"
